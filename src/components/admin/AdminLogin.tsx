...
export default function AdminLogin({ onSuccess }: AdminLoginProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6">
      <div className="border border-white/20 bg-zinc-950/90 backdrop-blur-xl p-8 relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-600 via-white to-red-600 animate-pulse" />
        
        <div className="mb-8">
          <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-[0.3em] text-red-500 mb-2">
            <Lock size={14} /> Backstage Access
          </div>
          <h2 className="text-3xl md:text-4xl italic font-black tracking-tighter leading-none text-white">
            WH!TE L!E ADMIN
          </h2>
        ...
        {error && (
          <div className="mb-6 p-3 bg-red-950/50 border border-red-500/50 text-red-300 text-xs font-mono flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-black/80 border border-white/20 px-4 py-3 text-white text-sm font-mono focus:border-white focus:outline-none transition-colors"
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between text-[10px] font-mono text-zinc-500">
